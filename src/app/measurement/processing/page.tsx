            ...
            <section className="relative flex min-h-screen flex-col items-center justify-center px-5">
                ...
                <div className="relative z-10 flex w-full max-w-md flex-col items-center text-center">
                    ...
                    <div className="relative flex h-[220px] w-[220px] items-center justify-center rounded-full border border-white/10 bg-white/5 backdrop-blur-md">
                        {/* OUTER PULSE */}
                        <div className="absolute h-[220px] w-[220px] animate-ping rounded-full border border-red-500/20" />

                        <div className="absolute h-[180px] w-[180px] rounded-full border border-red-500/30" />
                        ...
                        <div className="relative flex flex-col items-center">
                            ...
                            <div className="absolute left-1/2 top-8 h-[140px] w-[90px] -translate-x-1/2 overflow-hidden">
                                <div className="animate-bounce">
                                    <div className="h-[2px] w-full bg-red-500 shadow-[0_0_20px_rgba(239,68,68,0.9)]" />
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <Link
                        ...
                        className="mt-8 flex h-14 w-full items-center justify-center rounded-2xl bg-red-600 text-base font-semibold text-white transition hover:bg-red-700"
                    >
                        Continue
                    </Link>
