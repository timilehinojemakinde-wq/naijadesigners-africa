    ...
    return (
        <main className="min-h-screen bg-gray-50 pb-32">
            ...
            <div className="mx-auto max-w-md space-y-4 px-5 py-4">
                ...
                <section className="rounded-2xl bg-white p-5 shadow-sm">
                    <div className="flex items-center justify-between">
                        <h2 className="text-sm font-bold text-gray-900">Measurements</h2>
                        <span className="rounded-full bg-amber-100 px-2.5 py-0.5 text-[10px] font-semibold text-amber-700">
                            Pending
                        </span>
                    </div>
                    <p className="mt-2 text-xs text-gray-400">
                        No measurements yet. Send the AI measurement link to the customer.
                    </p>
                    <button className="mt-3 flex w-full items-center justify-center gap-2 rounded-xl bg-gray-900 py-2.5 text-xs font-semibold text-white">
                        <Ruler size={14} />
                ...
                <section className="rounded-2xl bg-white p-5 shadow-sm">
                    ...
                    <button className="mt-3 flex w-full items-center justify-center gap-2 rounded-xl border border-gray-200 py-2.5 text-xs font-semibold text-gray-700">
                        <FileText size={14} />
                        Generate Invoice
                    </button>
                </section>
